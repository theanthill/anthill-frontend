...
interface TokenExchangeInputProps {
  token: ERC20;
  tokenName: string;
...
const TokenExchangeInput: React.FC<TokenExchangeInputProps> = ({ token, tokenName, onChange=null, disable=false }) => {
...
export default TokenExchangeInput;
